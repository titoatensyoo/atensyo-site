export default function Learning() {
  const notes = [
    {
      title: "Belajar Bikin Konten AI di TikTok",
      date: "17 Mei 2026",
      preview: "Eksplor CapCut Pro untuk bikin konten AI dan upload ke TikTok...",
      href: "/notes/learning/belajar_konten_ai",
    },
  ];
  ...
  return (
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <section className="px-8 py-24 max-w-2xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-12">Learning</h1>
        <div className="flex flex-col gap-4">
          {notes.map((note) => (
            <a key={note.title} href={note.href} className="border border-gray-200 rounded-xl px-6 py-5 hover:bg-gray-50 transition">
