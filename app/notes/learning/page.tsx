export default function Learning() {
  const notes = [
    {
      title: "Cara bikin website dari nol",
      date: "16 Mei 2026",
      preview: "Belajar Next.js, Tailwind CSS, dan deploy ke Vercel...",
    },
  ];
        ...
        {notes.length === 0 ? (
          ...
          <div className="flex flex-col gap-4">
            {notes.map((note) => (
              <div
                key={note.title}
                className="border border-gray-200 rounded-xl px-6 py-5 hover:bg-gray-50 transition cursor-pointer"
              >
